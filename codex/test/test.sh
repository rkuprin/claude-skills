...
has "bypass posture (no prompts, no sandbox)" "$LOG" "--dangerously-bypass-approvals-and-sandbox"
...
has "resume bypass posture"           "$RLOG" "--dangerously-bypass-approvals-and-sandbox"
